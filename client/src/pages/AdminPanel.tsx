...
import {
  ...
  Headphones, MessageCircle, Send, History,
} from 'lucide-react';
...
export default function AdminPanel() {
  const { allOrders, totalSales, dispatchQueue, readyForPickupOrders } = useMarketplace();
  ...
  const handleApproveStore = (_storeId: string) => {
    toast.success('Loja aprovada com sucesso!');
  };

  const handleBlockStore = (_storeId: string) => {
    toast.error('Loja bloqueada!');
  };
                  ...
                  <Card key={store.id} className="p-6 hover:shadow-lg transition-all">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-3 pb-3 border-b border-border">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-foreground text-sm">{store.location}</p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-3 mb-4 text-center">
                      ...
                      <div className="bg-secondary rounded-lg p-2">
                        ...
                        <p className="font-bold text-primary text-sm">R$ {storeSales.toFixed(2)}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        variant="outline"
                        className="flex-1"
                        onClick={() => handleBlockStore(store.id)}
                      >
                        Bloquear
                      </Button>
                    </div>
