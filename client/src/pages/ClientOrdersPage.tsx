...
import {
  ...
  MapPin, History, CalendarClock, MessageCircle, X, Send, ShoppingBag,
  Signal, SignalLow
} from 'lucide-react';
...
function LiveMotoboyMap({ orderId, deliveryCoords }: { orderId: string; deliveryCoords?: [number, number] | null }) {
  const isActive = true;
